...
urlpatterns = [
    ...
    re_path(r'^networks/(?P<network_code>\w+)/station/(?P<station_code>\w+)/edit_basic/$',
        book_view.ExtBasicDataUpdateView.as_view(), name='station_edit_basic'),
    re_path(r'^networks/(?P<network_code>\w+)/station/(?P<station_code>\w+)/edit_owner/$',
        book_view.ExtOwnerDataUpdateView.as_view(), name='station_edit_owner'),
    re_path(r'^networks/(?P<network_code>\w+)/station/(?P<station_code>\w+)/edit_morphology/$',
        book_view.ExtMorphologyDataUpdateView.as_view(), name='station_edit_morphology'),
    re_path(r'^networks/(?P<network_code>\w+)/station/(?P<station_code>\w+)/edit_housing/$',
    ...
    re_path(r'^networks/(?P<network_code>\w+)/station/(?P<station_code>\w+)/edit_borehole_layer/(?P<pk>\w+)/$',
