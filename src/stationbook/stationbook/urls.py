...
urlpatterns = [
    ...
    path(
        "{}nodes/".format(SB_URL_BASE), book_view.NodesListView.as_view(), name="nodes"
    ),
    path(
    ...
    path(
        "{}links/".format(SB_URL_BASE), book_view.LinksListView.as_view(), name="links"
    ),
    path(
        "{}about/".format(SB_URL_BASE), book_view.AboutListView.as_view(), name="about"
    ),
    re_path(
    ...
    re_path(
        r"^{}networks/(?P<network_code>\w+)/(?P<network_start_year>\w+)/$".format(
            SB_URL_BASE
        ),
    ...
    re_path(
        r"^{}networks/(?P<network_code>\w+)/(?P<network_start_year>\w+)/stations/(?P<station_code>\w+)/(?P<station_start_year>\w+)/$".format(
            SB_URL_BASE
        ),
    ...
    re_path(
        r"^{}networks/(?P<network_code>\w+)/(?P<network_start_year>\w+)/stations/(?P<station_code>\w+)/(?P<station_start_year>\w+)/gallery/$".format(
            SB_URL_BASE
        ),
    ...
    re_path(
        r"^{}networks/(?P<network_code>\w+)/(?P<network_start_year>\w+)/stations/(?P<station_code>\w+)/(?P<station_start_year>\w+)/edit-basic/$".format(
            SB_URL_BASE
        ),
    ...
    re_path(
        r"^{}networks/(?P<network_code>\w+)/(?P<network_start_year>\w+)/stations/(?P<station_code>\w+)/(?P<station_start_year>\w+)/edit-owner/$".format(
            SB_URL_BASE
        ),
    ...
    re_path(
        r"^{}networks/(?P<network_code>\w+)/(?P<network_start_year>\w+)/stations/(?P<station_code>\w+)/(?P<station_start_year>\w+)/edit-morphology/$".format(
            SB_URL_BASE
        ),
    ...
    re_path(
        r"^{}networks/(?P<network_code>\w+)/(?P<network_start_year>\w+)/stations/(?P<station_code>\w+)/(?P<station_start_year>\w+)/edit-housing/$".format(
            SB_URL_BASE
        ),
    ...
    re_path(
        r"^{}networks/(?P<network_code>\w+)/(?P<network_start_year>\w+)/stations/(?P<station_code>\w+)/(?P<station_start_year>\w+)/edit-borehole/$".format(
            SB_URL_BASE
        ),
    ...
    re_path(
        r"^{}networks/(?P<network_code>\w+)/(?P<network_start_year>\w+)/stations/(?P<station_code>\w+)/(?P<station_start_year>\w+)/add-borehole-layer/$".format(
            SB_URL_BASE
        ),
    ...
    re_path(
        r"^{}networks/(?P<network_code>\w+)/(?P<network_start_year>\w+)/stations/(?P<station_code>\w+)/(?P<station_start_year>\w+)/edit-borehole-layer/(?P<layer_pk>\w+)/$".format(
            SB_URL_BASE
        ),
    ...
    re_path(
        r"^{}networks/(?P<network_code>\w+)/(?P<network_start_year>\w+)/stations/(?P<station_code>\w+)/(?P<station_start_year>\w+)/remove-borehole-layer/(?P<layer_pk>\w+)/$".format(
            SB_URL_BASE
        ),
    ...
    re_path(
        r"^{}networks/(?P<network_code>\w+)/(?P<network_start_year>\w+)/stations/(?P<station_code>\w+)/(?P<station_start_year>\w+)/upload-photo/$".format(
            SB_URL_BASE
        ),
    ...
    re_path(
        r"^{}networks/(?P<network_code>\w+)/(?P<network_start_year>\w+)/stations/(?P<station_code>\w+)/(?P<station_start_year>\w+)/edit-photo/(?P<photo_pk>\w+)/$".format(
            SB_URL_BASE
        ),
    ...
    re_path(
        r"^{}networks/(?P<network_code>\w+)/(?P<network_start_year>\w+)/stations/(?P<station_code>\w+)/(?P<station_start_year>\w+)/remove-photo/(?P<photo_pk>\w+)/$".format(
            SB_URL_BASE
        ),
