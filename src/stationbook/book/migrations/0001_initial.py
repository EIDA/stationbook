# Generated by Django 2.0.2 on 2018-02-22 14:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fdsn_network', models.ForeignKey(default=None, on_delete=django.db.models.deletion.PROTECT, related_name='fdsn_stations', to='book.FdsnNetwork')),
            ],
        ),
        migrations.CreateModel(
            name='Photo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fdsn_networks', models.ManyToManyField(related_name='editors', to='book.FdsnNetwork')),
        ...
        migrations.AddField(
            ...
            name='ext_basic_data',
            field=models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='station', to='book.ExtBasicData'),
        ),
        migrations.AddField(
            model_name='fdsnstation',
            name='ext_borehole_data',
            field=models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='station', to='book.ExtBoreholeData'),
        ),
        migrations.AddField(
            model_name='fdsnstation',
            name='ext_housing_data',
            field=models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='station', to='book.ExtHousingData'),
        ),
        migrations.AddField(
            model_name='fdsnstation',
            name='ext_morphology_data',
            field=models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='station', to='book.ExtMorphologyData'),
        ),
        migrations.AddField(
            model_name='fdsnstation',
            name='ext_owner_data',
            field=models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, related_name='station', to='book.ExtOwnerData'),
        ),
        migrations.AddField(
